    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src='/atharva-portfolio.jpeg'
              alt="Atharva Maskar Portrait"
              width="192"
              height="192"
              quality="95"
              priority={true}
      ...
      >
        ...
        experience in <span className="font-bold">Blockchain & Front-End Development</span>. My focus is{" "}
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/atharvamaskar/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/AtharvaMaskar26"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
